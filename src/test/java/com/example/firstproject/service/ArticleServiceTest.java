...
class ArticleServiceTest {
    ...
    void index() {
        ...
        List<Article> expected = Arrays.asList(a,b,c,d,e,f);
    ...
    @Test
    @Transactional
    @DisplayName("성공 : 존재하는 id와 title, content가 있는 dto 입력")
    void update1() {

    }
    @Test
    @Transactional
    @DisplayName("성공 : 존재하는 id와 title만 있는 dto 입력")
    void update2() {

    }
    @Test
    @Transactional
    @DisplayName("실패 : 존재하는 않는 id의 dto 입력")
    void update3() {
